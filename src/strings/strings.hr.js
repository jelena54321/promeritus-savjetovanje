strings = {
    ...
    home: "Početna",
    about_us: "O nama",
    vision_and_mission: "Vizija i misija",
    services: "Usluge",
    contact: "Kontakt",

    about_us_content: 
    `
    Promeritus savjetovanje ima cijeli spektar usluga savjetovanja s ciljem da vam omogući brzo i jednostavno ostvarivanje vrhunske usluge, u skladu s vlastitim potrebama. Pri tom nastojimo udružiti lokalna znanja i iskustvo iznimnih internacionalnih stručnjaka u našoj mreži, kako bi našim klijentima isporučili vrhunske usluge savjetovanja i edukacije.

    Uspjeh je moguć uz pristup koji usmjerava pozornosti na pojedinca sa svim njegovim različitostima i potiče primjenu inovacija i naprednih znanstvenih spoznaja. Uz to je nužan i standardiziran sustav osiguranja kvalitete.
    
    Promeritus savjetovanje je utemeljeno 2010. godine kao tvrtka za savjetovanje i usluge. Osnovna djelatnost tvrtke je savjetovanje vezano uz zdravstvo, a aktivnosti i usluge su usmjerene prema područjima savjetovanja vezanim uz farmaceutsku industriju te prema ostalim klijentima.
    
    Udovoljavajući zahtjevima klijenata, dali smo prednost ostvarivanju visoko specijaliziranih medicinskih usluga uz stručan i cjelovit pristup. Dio naših aktivnosti je vezan uz zdravstveno prosvjećivanje i educiranje, potičući time aktivnu brigu o zdravlju i unaprjeđenje kvalitete života.
